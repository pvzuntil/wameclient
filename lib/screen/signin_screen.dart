...
import 'package:wameclient/controller/signin_controller.dart';
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            BottomAnimation(),
            Title(),
            Content(signinController: signinController),
          ],
        ),
      ),
    );
...
class Content extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned.fill(
      top: Get.pixelRatio * 55,
      child: Align(
        child: Container(
          width: Get.width,
          height: Get.pixelRatio * 150,
          ...
          child: Column(
            ...
            children: [
              FormTextField(
                ...
                controller: signinController.textConNama,
              ),
              FormTextField(
                label: 'Masukkan Email ...',
                keyboardType: TextInputType.emailAddress,
                controller: signinController.textConEmail,
              ),
              FormTextField(
                label: 'Masukkan Password ...',
                keyboardType: TextInputType.visiblePassword,
                obscureText: true,
                controller: signinController.textConPassword,
              ),
              FormTextField(
                label: 'Konfirmasi Password ...',
                keyboardType: TextInputType.visiblePassword,
                obscureText: true,
                controller: signinController.textConPasswordKon,
              ),
              Container(
                  ...
                  children: [
                    Expanded(
                      child: RaisedButton(
                        ...
                        onPressed: () =>
                            signinController.doSignin(context: context),
                        child: Obx(
                          () => signinController.isLodingLogin.value
                              ? SizedBox(
